    ...
    render() {
        ...
        return (
            <Modal contentLabel="Modal" isOpen={this.props.show} onRequestClose={this.props.onClose} className="react-modal-content" overlayClassName="react-modal-overlay">
                ...
                <p>
                    If you prefer not to enter your password you can use a <a target="_blank" rel="noopener noreferrer" href={this.props.github + "/settings/tokens/new?description=CodeMana&scopes=gist"}>personal access token</a>.
